...
$stmt = $con->query("SELECT * FROM users1");

// Handle delete operation
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    $id = $_GET['id'];

    if (deleteDataById($con, 'users1', $id)) {
        echo "Record deleted successfully";
        echo "<script>window.location.href='delete1.php';</script>";
        ...
        <table>
            ...
            <?php  while($row = $stmt->fetch_assoc()) { ?>
                ...
                <td class="id"><?= $row['id'] ?></td>
                    ...
                    <td ><?= $row['password'] ?></td>
                    <td>
                    <center><img src=".\image\delete.png" width="40px"><br><br><a class="btn" href="delete1.php?action=delete&id=<?= $row['id'] ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete this record?');"><i class="fas fa-trash"></i> Delete</a>
            </center></td>
                    </tr>
            <?php } ?>
        </table>
